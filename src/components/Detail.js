      ...
      <div className="flex justify-center">
        ...
        <div className="border-2 border-gray-200 px-3 rounded-lg pb-3">
          ...
          <div className="flex justify-between">
            ...
            <Link to="/">
            <button className="h-6 px-2 font-bold text-black bg-gray-200 rounded-lg mb-3 mt-3">
              Back
            </button>
            </Link>
          </div>
          <div className="text-gray-500 text-xs w-60">
              <span className="font-bold">Detail Description : </span><br/>{item[0].detailDescrption}</div>
